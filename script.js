...
/* ---------------------------------------------------------
   ...
   --------------------------------------------------------- */
const HISTORY = [
  "본 연구원은 2024년 2월 '이상현상 처리부'라는 명칭으로 설립되었습니다. 당시에는 위험성을 고려하여 군인 및 특수요원이 탐사에 투입되고, 역사 연구자들은 자문을 맡는 형태였습니다. 그러나 이상현상 및 그 개체들이 실제 역사와의 관련도가 높은 바, 역사적 지식이 풍부한 자가 파훼법을 찾아내 생환할 가능성이 높은 것으로 확인되었습니다. 이후 2024년 10월부터 역사 연구자들이 탐사를, 군인 및 특수요원 출신들이 탐사 전후 처리와 현장 관리를 맡는 '한국사 이상현상 연구원'으로 개편되었습니다. 연구원 초기에는 전문성을 고려해 대학원생 이상의 학력자들로 탐사팀을 구성했습니다. 그러나 학구열이 지나친 이들이 이상 개체를 실제 역사적 인물로 착각, 무리하게 접촉하다 사망하는 일이 다수 발생했습니다. 이후로는 역사학과 학부생 중에서도 그 지적 소양이 인정되는 경우 채용해오고 있으며, 현장과 학술이 균형을 이루는 차세대 탐사 인재를 선발·육성하고 있습니다.",
  "두 번째 문단을 입력하세요. 조직이 어떻게 커졌고 지금 무엇을 하는지 적어 주세요.",
];
